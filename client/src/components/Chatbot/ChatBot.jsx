...
//       ])
//     } catch (error) {
//       setChatMessages((prev) => [...prev.slice(0, -1), { type: "bot", content: "Error fetching response", timestamp }])
//     } finally {
//       setIsAnalyzing(false)
//     }
...
//       <Button
//         size="icon"
//         className="w-14 h-14 rounded-full bg-[#688C05] hover:bg-[#4B6601] shadow-lg z-20"
//         onClick={onToggle}
//       >
//         <img src={BotIcon || "/placeholder.svg"} alt="Bot Icon" className="w-12 h-12" />
//       </Button>
...
//                       <div className="flex items-center gap-2 mb-1">
//                         <div className="w-8 h-8 rounded-full bg-[#688C05] flex items-center justify-center">
//                           <img src={BotIcon || "/placeholder.svg"} alt="Bot Icon" className="w-8 h-8" />
//                         </div>
//                         <span className="text-xs font-medium">Assistant</span>
//                       </div>
//                     )}
//                     <div
//                       className={`max-w-[80%] rounded-2xl px-4 py-2 text-sm ${message.type === "user" ? "bg-[#688C05] text-white rounded-br-none" : "bg-[#F1F7FF] text-gray-800 rounded-tl-none"}`}
//                     >
//                       {typeof message.content === "string" ? message.content : message.content}
//                     </div>
//                     <span className="text-xs text-gray-500 mt-1">{message.timestamp}</span>
      ...
      <AnimatePresence>
        {!isMinimized && (
          <motion.div
            ...
            exit={{ x: "100%" }}
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="fixed top-0 right-0 z-40 h-full w-[380px] shadow-xl"
          >
            <div className="flex flex-col h-full bg-white">
              {/* Chat Header */}
              <div className="bg-[#4B6601] py-3 px-4 flex items-center justify-between">
                <h2 className="text-white font-semibold">PharmaX Bot</h2>
                <Button
                  size="icon"
                  variant="ghost"
                  ...
                  >
                    ...
                    <div
                      className={`max-w-[80%] rounded-2xl px-4 py-2 text-sm ${
                        message.type === "user"
                          ? "bg-[#688C05] text-white rounded-br-none"
                          : "bg-[#F1F7FF] text-gray-800 rounded-tl-none"
                      }`}
                    >
                      {typeof message.content === "string" ? message.content : message.content}
                    </div>
              ...
              {/* Input Field - Fixed at bottom of sidebar */}
