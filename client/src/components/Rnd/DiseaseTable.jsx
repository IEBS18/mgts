    ...
    <Card className="mb-8 shadow-md">
      <CardHeader className="pb-3 bg-[#f9faf5]">
        ...
        <div className="flex items-center gap-4 mt-2">
          {sseError && <p className="text-destructive text-sm">{sseError}</p>}
          {isLoading && (
            <div className="flex items-center gap-2 text-muted-foreground text-sm bg-[#f9faf5] p-2 rounded-md">
              <Loader2 className="animate-spin h-4 w-4 text-[#6b8e23]" />
              <span>Loading disease data...</span>
            </div>
          )}
        </div>
      </CardHeader>
                  ...
                  <tr>
                    <td colSpan={visibleColumns.length} className="p-6 text-center">
                      <div className="flex flex-col items-center gap-3 py-12">
                        ...
                        <p className="text-base font-medium text-[#6b8e23]">
                          Loading disease data for {selectedDisease === "all" ? "all diseases" : selectedDisease}...
                        </p>
                      </div>
                    </td>
                  </tr>
