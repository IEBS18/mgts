...
//   // ------------------- Original "Drug" search replaced by TPP logic -------------------
//   // We will not do the old `handleSearchSubmitDrug` from the original. 
//   // Instead, see TPP-based "drug" code further down.
...
//       label: item,
//     }))
//     // If the incoming options are objects with { value, label }, skip re-wrapping
//     // For TPP data we already have arrays of strings, so we do the map above.
...
//               A high-level overview of the selected indication, covering disease biology,
//               risk factors, standard treatment protocols, and key unmet needs.
//               Ideal for developing a foundational understanding or refining strategic focus.
//             </p>
//           </div>
//         </DialogHeader>
...
//             {/* ---------- Drug Tab (now using TPP sub-tabs) ---------- */}
