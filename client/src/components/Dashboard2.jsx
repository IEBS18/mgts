...
// import React, { useState, useEffect } from 'react';
// import { Search, FileText, Activity, X, Map, ClipboardList, Award, Users } from 'lucide-react';
// import { ComposableMap, Geographies, Geography } from 'react-simple-maps';
// import { Tooltip } from '@visx/tooltip';
...
// import WorldMap from './WorldMap';
// import DiseaseOverview from './DiseaseOverview';
// import CompetitiveLandscapeModal from './CompetitiveLandscape'; // Ensure the path is correct
// import DrugCostPredictionModal from './DrugCostPredictionModal';
// import { Button } from "@/components/ui/button";
// import { ScrollArea } from "@/components/ui/scroll-area";
// import { Separator } from "@/components/ui/separator';
...
//     icon: <Map className="w-6 h-6" />,
//     title: "Competitive Landscape",
//     description: "Analyze the competitive environment, key players, and market dynamics. Understand your position and identify opportunities.",
//   },
//   {
//     icon: <Activity className="w-6 h-6" />,
//     title: "Disease Overview",
...
//                       <DiseaseOverview />
//                     ) : report.title === "Competitive Landscape" ? (
//                       <CompetitiveLandscapeModal /> {/* Render the new component */}
//                     ) : report.title === "Price Prediction" ? (
//                       <DrugCostPredictionModal />
//                     ) : (
//                       <Button className="w-full md:w-auto bg-[#a6ce39] text-black rounded-[12px] hover:bg-[#95b833]">
